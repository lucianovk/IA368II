...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            Node(
                package='my_robot_pkg',
                executable='my_robot_room_segmentation_node',
                name='my_robot_room_segmentation_node',
                output='screen',
                arguments=log_args,
                parameters=[{'use_sim_time': use_sim_time}],
            ),
            Node(
                package='my_robot_pkg',
                executable='my_robot_semantic_room_segmentation_node',
                name='my_robot_semantic_room_segmentation_node',
                output='screen',
                arguments=log_args,
                parameters=[{'use_sim_time': use_sim_time}],
            ),
